...
<div class="card border-info mb-3 clo-lg-8" >
    ...
    @if($quotation->total_cost)
     ...
     @endif
      ...
      @else
      @endif
      <a href="{{ Route('Destroy',$quotation->id)}}"style="margin:5px;" class="btn btn-danger col-lg-2 float-right btn-sm" onclick="return confirm('Are you sure you want to delete this item?');" >Delete  </a>
